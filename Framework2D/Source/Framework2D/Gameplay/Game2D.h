...
namespace Framework2D {
	...
	public:
		...
		inline const Vec2Int& GetGameBoundLeft() const { return GameBoundLeft; }
		inline const Vec2Int& GetGameBoundRight() const { return GameBoundRight; }
