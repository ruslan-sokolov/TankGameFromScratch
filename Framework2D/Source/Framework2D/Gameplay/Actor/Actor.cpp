...
{	
	Actor::Actor(const std::string& Name, const Vec2Int& Position)
	...
	inline void Actor::SetPosition(const Vec2Int& NewPos, bool bSweep)
	{
	...
	inline void Actor::SetSize(const Vec2Int& NewSize, bool bTranslateToComponents)
	{
