...
{
	SpriteFlipFlop::SpriteFlipFlop(const std::string& Name, Texture* TextureFlip, Texture* TextureFlop, const Vec2Int& Position, 
	...
	SpriteFlipFlop::SpriteFlipFlop(const std::string& Name, const std::string& TextureFlipPath, const std::string& TextureFlopPath, const Vec2Int& Position,
		float FlipFlopRate, bool bAutoFlipFlopEnabled,
		const Vec2Int& Size, const Vec4& Color, bool bEnableRender)
