...
namespace Game {
	...
	public:
		...
		void Init() override
		{
			...
			GroupTest_2->AddSprite(new SpriteEntity("TestSprite", T_TANK_EB_RIGHT_1, VecInt2D(0, 0), VecInt2D(64, 64)));
			...
			GroupTest_2->AddSprite(new SpriteEntity("TestSprite", T_TANK_EB_UP_0, VecInt2D(148, 0)));
